...
const Forms = (props) => {
  ...
  return (
    <div>
      <div className={` container overflow-hidden flex justify-center items-center ${props.classNameTwo}`}>
        <form
          onSubmit={Submit}
          className={`w-[600px] h-auto px-[36px] shadow-xl rounded-lg ${props.classNameOne}`}
        >
          <h1 className={`text-green-400 font-bold text-[56px] mb-[26px] text-center ${props.hOne}`}>
            {props.Header}
          </h1>
          ...
          <div className="flex justify-center items-center">
            <button
              className={`w-[200px] h-[50px]  bg-green-600 flex justify-center items-center rounded-lg font-medium text-[16px] text-white transition-all duration-[.3s] hover:bg-green-500  ${props.btnStyle}`}
              type="submit"
            >
              {props.btn}
            </button>
